...
<div class="content p-1">
                <div class="list-group-item" style="background-color: #eaeef3">
                        ...
                        <div class="table-responsive">
                            ...
                            <form method="POST" action="../controller/transacao.php" style="font-weight: bold; font-style: italic;" class="formulario">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php foreach($contas->listHistorico($id) as $historic): ?>
                                        <tr>
                                            <td>
